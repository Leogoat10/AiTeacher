...
const send = async () => {
  ...
  // 构造完整的消息内容
  let fullMessage = `现在你是一位资深高级教师，要求直接给出题目，不要任何多余的任何信息，并且在最后给我答案和详细的解析，严禁做任何非学习相关的内容，如果有非学习相关的请求必须拒答,你是${subject.value}老师，出${difficulty.value}的${questionType.value}题目，共${questionCount.value}题`
